...
const languageString = {
  en: {
    translation: {
      ...
      GAME_NAME: 'Grammy',
      HELP_MESSAGE: 'I will ask you %s multiple choice questions. Respond with the correct option of the answer. For example, say one, two, three, or four. To start a new game at any time, say, start game. ',
      REPEAT_QUESTION_MESSAGE: 'I can repeat the last question, say, repeat. ',
      ASK_MESSAGE_START: 'Do you want to start playing?',
      HELP_REPROMPT: 'To give answer to the question, respond with the number of the answer. Like one for first answer. ',
      STOP_MESSAGE: 'Would you like to continue playing?',
      CANCEL_MESSAGE: 'Ok, hope to play again soon.',
      NO_MESSAGE: 'Ok, we\'ll play another time. Goodbye and talke care!',
      TRIVIA_UNHANDLED: 'Try saying a number between 1 and %s',
      HELP_UNHANDLED: 'Say yes to continue and  no to end the game.',
      START_UNHANDLED: 'Say start or open to start a new game.',
      NEW_GAME_MESSAGE: 'Welcome to %s. ',
      WELCOME_MESSAGE: 'I will ask you %s questions related to grammar and vocabulary, try to get as many correct as you can. Just say the number of the answer. Let\'s begin.          ',
      ANSWER_CORRECT_MESSAGE: 'yes,correct. ',
      ANSWER_WRONG_MESSAGE: 'no,wrong. ',
      CORRECT_ANSWER_MESSAGE: 'The correct answer is %s: %s. ',
      ANSWER_IS_MESSAGE: 'Your answer is ',
